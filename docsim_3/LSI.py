...
def classify(k=None):
    ...
    f2=codecs.open("label_level05.txt",'r',encoding="utf-8").readlines()
    for li in f[:11901]:
        li=li.split()
...
# parameters={"K":[3,5,7]}
# clf = GridSearchCV(classify(), parameters)
classify(k=5)
